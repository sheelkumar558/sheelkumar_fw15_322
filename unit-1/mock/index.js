...
async function edit(item) {
  document.getElementById("inputCountry").value = item.country;
  document.getElementById("inputCity").value = item.city;
  document.getElementById("inputPopulation").value = item.population;
  document.getElementById("Id").value = item.id;
  document.querySelector(".editForm").style.display = "block";
}
function update() {
  let id = document.getElementById("Id").value;
  let cont = document.getElementById("inputCountry").value;
  let city = document.getElementById("inputCity").value;
  let pop = document.getElementById("inputPopulation").value;
